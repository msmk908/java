...
public class JTableExampleExample1 extends JFrame {
   private JTable jTable;
   private JPanel pSouth;
   private JTextField txtInfo; // 텍스트 필드 하나로 변경
   private Object[][] rowData;

   public JTableExampleExample1() {
      this.setTitle("JTableExampleExample1");
   ...
   public JTable getJTable() {
      if (jTable == null) {
         ...
         rowData = new Object[][] { { "이성종", 20 }, { "백민규", 23 }, { "신지원", 22 } };
   ...
   public static void main(String[] args) {
      SwingUtilities.invokeLater(new Runnable() {
         public void run() {
            JTableExampleExample1 jFrame = new JTableExampleExample1();
